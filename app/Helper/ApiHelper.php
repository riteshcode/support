    ...
    */
        ...
        public static function essential_config_regenerate($db_id){
            ...
            //ECOMM RELATED TABLE
               ...
               $app_settings = $db_name .'.app_settings';
            ...
            //HRM RELATED TABLE
               ...
               $app_email_templates = $db_name .'.app_email_templates';
                ...
                $app_settings = 'support_subs_0001.app_settings';
               $app_settings_group = 'support_subs_0001.app_settings_group';
               $web_template_setting = $db_name .'.web_template_setting';
        ...
        //Global start
            ...
            $web_functions = $db_name2 .'.web_functions';
            ...
            $mas_payment_method_details_table = $db_name2 .'.mas_payment_method_key';
            ...
            $web_banner_position = $db_name2 .'.web_banner_position';                
            $web_menu_group   = $db_name2 .'.web_menu_group';
            
            $web_template_component_setting  = $db_name2 .'.web_template_component_setting';
           
            $web_templates = $db_name2 .'.web_templates';
            $web_template_section_options = $db_name2 .'.web_template_section_options';
            $web_template_sections = $db_name2 .'.web_template_sections';

            $web_template_component = $db_name2 .'.web_template_component';

            // $mas_shipping_method  = $db_name2 .'.mas_shipping_method';
            // $mas_shipping_method_key  = $db_name2 .'.mas_shipping_method_key';
        ...
        // Statisc Table with subscriber_demo_db
            ...
            $app_email_group = 'support_subs_0001.app_email_group';
            $app_email_templates = 'support_subs_0001.app_email_templates';
            
            $subscriber_web_template_component_setting  = 'support_subs_0001.web_template_component_setting';
        ...
        //Global end
            ...
            config(['dbtable.app_settings' =>  $app_settings ]);
        ...
        if(!empty($imageInfo)){
            switch ($image_type) {
                ...
                case (4):
                    ...
                    $folderPath = $mainPath.'/setting/'.$file_name;
                    ...
                    // attach directory to db
                    $imageInfo->images_directory = $folderPath;
                    $imageInfo->images_size = json_encode([]);
                    $imageInfo->images_status = 'live';
