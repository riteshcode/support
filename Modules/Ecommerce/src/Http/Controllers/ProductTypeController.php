...
class ProductTypeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($product_type){
            return ApiHelper::JSON_RESPONSE(true,$fieldsgrouparray,'PRODUCTTYPE_CREATED');
        }else{
    ...
    public function update(Request $request)
    {
        ...
        if($product_type){
            return ApiHelper::JSON_RESPONSE(true,$fieldsgrouparray,'PRODUCTTYPE_UPDATED');
        }else{
            return ApiHelper::JSON_RESPONSE(false,[],'SOME_ISSUE');
        }
    }
    ...
    public function changeStatus(Request $request){
        $api_token = $request->api_token;
        $infoData = ProductType::find($request->product_type_id);
